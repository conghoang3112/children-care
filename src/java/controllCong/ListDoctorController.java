 ...
 * @author congh
 */
@WebServlet(name = "ListDoctorController", urlPatterns = {"/listDoctorController"})
...
//        }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("ViewListDoctorCONG.jsp").forward(request, response);
    }
