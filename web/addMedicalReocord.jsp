                ...
                <div class="container-fluid">
                    <div class="layout-specing">
                        <h3 class="mb-0" style="margin: 0 auto">Add Medical Record</h3>
                            ...
                            <form action="add-medical-record" method="Post" style="margin: 0 auto">
                                <table>      
                                    <tr>
                                        <td>Disease Name</td>
                                        <td><input type="text" name="disease-name" value="" /></td>
                                    </tr>
                                    <tr>
                                        <td>Reservation ID</td>
                                        <td><input type="text" name="reservation_id" value="" /></td>
                                    </tr>
                                    <tr>
                                        <td>Prescription</td>
                                        <td><input type="text" name="prescription" value="" /></td>
                                    </tr>
                                    <tr>
                                        <td>Record note</td>
                                        <td><input type="text" name="record-note" value="" /></td>
                                    </tr>
                                    <tr>
                                        <td></td>
