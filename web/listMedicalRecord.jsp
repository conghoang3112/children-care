            ...
            <main class="page-content bg-light">
                ...
                <div class="container-fluid">
                    <div class="layout-specing">
                        ...
                        <a href="add-medical-record" style="margin-top: 20px;display: block">Create new Medical Record</a>
                        <div class="row">
                            <table class="table">
                                <thead class="thead-dark">
                                    <tr>
                                        <th style="border-left: 1px solid gray;border-top: 1px solid gray" scope="col">Record ID</th>
                                        <th style="border-left: 1px solid gray;border-top: 1px solid gray" scope="col">Reservation ID</th>
                                        <th style="border-left: 1px solid gray;border-top: 1px solid gray" scope="col">Disease</th>
                                        <th style="border-left: 1px solid gray;border-top: 1px solid gray" scope="col">Prescription</th>
                                        <th style="border-left: 1px solid gray;border-top: 1px solid gray" scope="col">Record note</th>
                                        <th style="border-left: 1px solid gray;border-top: 1px solid gray" scope="col">Action</th>
                                    </tr>
                                </thead>
                                <tbody>
                                
                                <c:forEach items="${listMedicalRecords}" var="mediaRecord">
                                    <tr>
                                        <td scope="row" style="border-left: 1px solid gray">${mediaRecord.id}</td>
                                        <td style="border-left: 1px solid gray">${mediaRecord.reservation}</td>
                                        <td style="border-left: 1px solid gray">${mediaRecord.dieaseName}</td>
                                        <td style="border-left: 1px solid gray">${mediaRecord.prescription}</td>
                                        <td style="border-left: 1px solid gray">${mediaRecord.recordNote}</td>
                                        <td style="border-left: 1px solid gray"><a href="update-medical-record?recordId=${mediaRecord.id}">Update</a> | <a href="delete-medical-record?recordId=${mediaRecord.id}">Delete</a> | <a href="view-detail-Mrecord?recordId=${mediaRecord.id}">View Detail</a></td>
                                    </tr>
                                </c:forEach>
                                </tbody>
                            </table>
