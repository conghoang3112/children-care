            ...
            <nav id="sidebar" class="sidebar-wrapper">
                <div class="sidebar-content" data-simplebar style="height: calc(100% - 60px);">
                    ...
                    <ul class="sidebar-menu pt-3">
                        ...
                        <li class="sidebar-dropdown">
                            <a href="Reservation_List"><i class="uil uil-apps me-2 d-inline-block"></i>Reservation</a>

                        </li>

                        <li class="sidebar-dropdown">
                            <a href="mediaRecord_list"><i class="uil uil-shopping-cart me-2 d-inline-block"></i>Medical Record</a>
                        </li>
                ...
                <div class="container-fluid">
                    <div class="layout-specing">
                        ...
                        <div class="row">
                            <table class="table">
                                <thead class="thead-dark">
                                    <tr>
                                        ...
                                        <th style="border-left: 1px solid gray;border-top: 1px solid gray" scope="col">Issue</th>
                                        <th style="border-left: 1px solid gray;border-top: 1px solid gray" scope="col">Parents Name</th>
                                    </tr>
                                </thead>
                                <tbody>

                                    <c:forEach items="${reservations}" var="C">
                                        <tr>
                                           <td scope="row" style="border-left: 1px solid gray">${C.id}</td>
                                            ...
                                            <td style="border-left: 1px solid gray">${C.issue}</td>
                                            <td style="border-left: 1px solid gray">${C.ulast_name} ${C.ufirst_name}</td>
                           ...
                           <c:choose>
                            <c:when test="${reservations == null || reservations.size() == 0}">
                                <h2>Not Found</h2>
                            </c:when>
                            <c:otherwise>
                                <nav aria-label="Page navigation example" class="">
                                    <ul class="pagination flex justify-content-center">
                                        <li class="page-item"><a class="page-link" href="Reservation_List?page=${page-1}">Previous</a></li>

                                        <c:forEach begin="1" end="${totalPage}" var="i">
                                            <li class="page-item ${i == page?"active":""}"><a class="page-link" href="Reservation_List?page=${i}">${i}</a></li>
                                            </c:forEach>

                                        <li class="page-item"><a class="page-link" href="Reservation_List?page=${page+1}">Next</a></li>
                                    </ul>
                                </nav>
                            </c:otherwise>
                        </c:choose>
