            ...
            <main class="page-content bg-light">
                ...
                <div class="container-fluid">
                    <div class="layout-specing">
                        <h3 class="mb-0" style="margin: 0 auto">Add Medical Record</h3>

                        
                            <form action="update-medical-record" method="Post" style="margin: 0 auto">
                                <table>
                         
                                    <input type="hidden" name="MRId" value="${medicalRecord.id}" />
                    
                                    <tr>
                                        <td>Disease Name</td>
                                        <td><input type="text" name="disease-name" value="${medicalRecord.dieaseName}" /></td>
                                    </tr>
                                    <tr>
                                        <td>Reservation ID</td>
                                        <td><input type="text" name="reservation_id" value="${medicalRecord.reservation}" /></td>
                                    </tr>
                                    <tr>
                                        <td>Prescription</td>
                                        <td><input type="text" name="prescription" value="${medicalRecord.prescription}" /></td>
                                    </tr>
                                    <tr>
                                        <td>Record note</td>
                                        <td><input type="text" name="record-note" value="${medicalRecord.recordNote}" /></td>
                                    </tr>
                                    <tr>
                                        <td></td>
                                ...
                                <a class="btn btn-primary" href="mediaRecord_list">BACK</a>
                            </form>
